...
namespace LowPolyHnS.Characters
{
    ...
    public class CharacterStateEditor : Editor
    {
        private const string PATH_RTC_SIM =
            "Assets/Plugins/LowPolyHnS/Characters/Animations/Overriders/Simple.overrideController";

        private const string PATH_RTC_LOC =
            "Assets/Plugins/LowPolyHnS/Characters/Animations/Overriders/Locomotion.overrideController";
