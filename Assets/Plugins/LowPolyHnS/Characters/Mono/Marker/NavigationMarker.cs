...
namespace LowPolyHnS.Characters
{
    ...
    [AddComponentMenu("LowPolyHnS/Characters/Marker", 100)]
    public class NavigationMarker : MonoBehaviour
    {
        ...
        private static readonly Vector2[] GIZMO_OUTLINE_MESH =
        {
        ...
        public const string LABEL_KEY = "LowPolyHnS-marker-label";
#endif
        ...
        public string label = "";
        [Range(0.0f, 5.0f)] public float stopThreshold = 0.0f;
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawMesh(GetMarkerMesh(), position, transform.rotation, Vector3.one);

            Gizmos.color = new Color(color.r, color.g, color.b, 0.5f);
            Mesh mesh = GetMarkerMesh();
            ...
            if (stopThreshold > Mathf.Epsilon)
            {
                Handles.color = color;
                Handles.DrawWireDisc(position, Vector3.up, stopThreshold);
            }
#endif
        }
        ...
        {
            if (GIZMO_MESH == null) GIZMO_MESH = GenerateMarkerMesh();
            return GIZMO_MESH;
        }
