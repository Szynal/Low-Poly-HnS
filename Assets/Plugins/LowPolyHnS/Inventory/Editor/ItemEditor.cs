...
namespace LowPolyHnS.Inventory
{
    ...
    public class ItemEditor : Editor
    {
        ...
        private const string PATH_PREFAB_CONSUME = "Assets/Plugins/LowPolyHnSData/Inventory/Prefabs/Consumables/";
        private const string NAME_PREFAB_CONSUME = "consume.prefab";

        private const string PATH_PREFAB_EQUIP_COND = "Assets/Plugins/LowPolyHnSData/Inventory/Prefabs/Conditions/";
        private const string NAME_PREFAB_EQUIP_COND = "equip.prefab";

        private const string PATH_PREFAB_EQUP = "Assets/Plugins/LowPolyHnSData/Inventory/Prefabs/Equip/";
