...
{
    public FE_Item RepresentedItem;
    [Space(5f)] [SerializeField] private Text itemName = null;
    [SerializeField] private Text itemUses = null;
    ...
    public void SetItem(FE_Item _newItem)
    {
        ...
        if (_newItem is FE_Weapon)
        {
            ...
            itemUses.text =
                $"{_wep.MagAmmoLeft} / {FE_PlayerInventoryInteraction.Instance.GetCurrentAmmoCount(_wep.AmmoType)}";
        }
        else
        {
